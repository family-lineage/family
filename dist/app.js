...
/***/ function(module, exports) {
	...
	var _user$project$Models$newPerson = function (model) {
		return {
			id: _elm_lang$core$List$length(model.people) + 1,
			name: model.personName,
			gender: model.personGender,
			fatherId: _elm_lang$core$Maybe$Nothing,
			motherId: _elm_lang$core$Maybe$Nothing,
			spouseId: _elm_lang$core$Maybe$Nothing,
			isPersonSelf: model.isPersonSelf
		};
	};
	var _user$project$Models$Person = F7(
		function (a, b, c, d, e, f, g) {
			return {id: a, name: b, gender: c, fatherId: d, motherId: e, spouseId: f, isPersonSelf: g};
		});
	var _user$project$Models$Model = F7(
		function (a, b, c, d, e, f, g) {
			return {people: a, personId: b, personName: c, personGender: d, isPersonSelf: e, isFormValid: f, mdl: g};
		});
	var _user$project$Models$Female = {ctor: 'Female'};
	var _user$project$Models$Male = {ctor: 'Male'};
	var _user$project$Models$initialModel = {
		people: {ctor: '[]'},
		personId: _elm_lang$core$Maybe$Nothing,
		personName: '',
		personGender: _user$project$Models$Male,
		isPersonSelf: false,
		isFormValid: false,
	...
	var _user$project$Messages$Save = {ctor: 'Save'};
	var _user$project$Messages$ToggleIsPersonSelf = {ctor: 'ToggleIsPersonSelf'};
	var _user$project$Messages$ChangePersonGender = function (a) {
		return {ctor: 'ChangePersonGender', _0: a};
	};
	var _user$project$Messages$ChangePersonName = function (a) {
		return {ctor: 'ChangePersonName', _0: a};
	};
	var _user$project$Messages$UpdatePerson = function (a) {
		return {ctor: 'UpdatePerson', _0: a};
	};
	var _user$project$Messages$NoOp = {ctor: 'NoOp'};

	var _user$project$Updates$savePerson = function (model) {
		var _p0 = model.personId;
		if (_p0.ctor === 'Just') {
			var updatePerson = function (existingPerson) {
				return _elm_lang$core$Native_Utils.eq(_p0._0, existingPerson.id) ? _elm_lang$core$Native_Utils.update(
					existingPerson,
					{name: model.personName, gender: model.personGender, isPersonSelf: model.isPersonSelf}) : existingPerson;
			};
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						people: A2(_elm_lang$core$List$map, updatePerson, model.people),
						personId: _elm_lang$core$Maybe$Nothing,
						personName: '',
						isPersonSelf: false
					}),
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						people: {
							ctor: '::',
							_0: _user$project$Models$newPerson(model),
							_1: model.people
						},
						personId: _elm_lang$core$Maybe$Nothing,
						personName: '',
	...
	var _user$project$Updates$update = F2(
		function (msg, model) {
			...
			switch (_p1.ctor) {
				case 'Save':
					return _user$project$Updates$savePerson(model);
				case 'UpdatePerson':
					var _p2 = _p1._0;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								personId: _elm_lang$core$Maybe$Just(_p2.id),
								personName: _p2.name,
								personGender: _p2.gender,
								isPersonSelf: _p2.isPersonSelf
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'ChangePersonName':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								personName: _p3,
								isFormValid: !_elm_lang$core$String$isEmpty(_p3)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'ChangePersonGender':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
	...
	var _user$project$Views$personView = function (person) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Messages$UpdatePerson(person)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					A2(_elm_lang$core$Basics_ops['++'], person.name, ' (click to edit)')),
				_1: {ctor: '[]'}
			});
	};
	var _user$project$Views$peopleView = function (people) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, _user$project$Views$personView, people));
	};
	var _user$project$Views$radio = F5(
		function (radioGroup, fieldLabel, counter, model, gender) {
			return A5(
				...
				model.mdl,
				{
					...
					_0: _debois$elm_mdl$Material_Toggles$value(
						_elm_lang$core$Native_Utils.eq(model.personGender, gender)),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Toggles$group(radioGroup),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: _debois$elm_mdl$Material_Options$onToggle(
									_user$project$Messages$ChangePersonGender(gender)),
								_1: {ctor: '[]'}
							}
						}
					}
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(fieldLabel),
					_1: {ctor: '[]'}
				});
		});
	var _user$project$Views$checkbox = F3(
		function (msg, model, name) {
			return A5(
				...
				model.mdl,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Toggles$value(model.isPersonSelf),
							_1: {ctor: '[]'}
						}
					}
				},
	...
	var _user$project$Views$namePerson = function (model) {
		return A5(
			...
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Textfield$label('e.g. Telolet'),
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Textfield$text_,
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Textfield$value(model.personName),
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onInput(_user$project$Messages$ChangePersonName),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	var _user$project$Views$defaultButtonAttributes = {
		ctor: '::',
	...
	var _user$project$Views$buttonAttributes = function (isDisabled) {
		return isDisabled ? A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Views$defaultButtonAttributes,
			{
				ctor: '::',
	...
	var _user$project$Views$personForm = function (model) {
		return A2(
			_elm_lang$html$Html$form,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Messages$Save),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Views$namePerson(model),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A5(_user$project$Views$radio, 'Gender', 'Male', 2, model, _user$project$Models$Male),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$span,
													{
														...
														_0: _elm_lang$html$Html_Attributes$style(
															{
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'margin-left', _1: '2rem'},
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													},
												...
												_1: {
													ctor: '::',
													_0: A5(_user$project$Views$radio, 'Gender', 'Female', 3, model, _user$project$Models$Female),
													_1: {ctor: '[]'}
												}
											}
										}),
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: A3(_user$project$Views$checkbox, _user$project$Messages$ToggleIsPersonSelf, model, 'Is this you?'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												_user$project$Views$row,
												{
													...
													_0: A5(
														...
														model.mdl,
														_user$project$Views$buttonAttributes(!model.isFormValid),
														{
															ctor: '::',
	...
	var _user$project$Views$formView = function (model) {
		return A2(
			_debois$elm_mdl$Material_Grid$grid,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Views$personForm(model),
						_1: {
							ctor: '::',
							_0: A2(
							...
							_1: {
								ctor: '::',
								_0: _user$project$Views$peopleView(model.people),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$hr,
				...
				},
				{
					header: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Family Tree'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					...
					main: {
						ctor: '::',
						_0: _user$project$Views$formView(model),
						_1: {ctor: '[]'}
					}
				}));
	};
	...
	var _user$project$Main$main = _elm_lang$html$Html$program(
		{init: _user$project$Main$init, view: _user$project$Views$view, update: _user$project$Updates$update, subscriptions: _user$project$Main$subscriptions})();
